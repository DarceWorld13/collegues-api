...
import colleguesapi.colleguesapispringboot.entite.InfosAuthentification;
...
public class AuthentificationCtrl {
	...
	@Autowired
	  ...
	  public ResponseEntity authenticate(@RequestBody InfosAuthentification authenticationRequest, HttpServletResponse response ) {
	    ...
	    UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken =
	    		new UsernamePasswordAuthenticationToken(authenticationRequest
	    				.getEmail(), authenticationRequest.getMotDePasse());
	 ...
	 @GetMapping(value = "/me")
	  public Collegue connecte() {
		  
		 String name = SecurityContextHolder.getContext().getAuthentication().getName();
		 
		 Collegue collegueFound = colService.recupColParEmail(name); 
